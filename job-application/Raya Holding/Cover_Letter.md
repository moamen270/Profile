# Cover Letter — Raya Holding (Software Development Specialist, .NET)
...
I'm applying for the Software Development Specialist (.NET) role. For the past ~3 years at Andalusia Health Business Solution I've designed and built .NET applications on a large enterprise codebase serving the Andalusia hospital group in Egypt and Saudi Arabia — with a track record of measurable engineering impact, not just feature delivery.
