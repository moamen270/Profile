...
**.NET Software Development Specialist | Backend & Distributed Systems**
...
### .NET Software Engineer — Andalusia Health Business Solution (AHBS)
...
- Built a PropTech marketplace backend from scratch, including shared-property booking, policy enforcement, and preference matching.
...
- Developed backend systems for e-commerce and booking platforms end-to-end, from requirements analysis through implementation, deployment, and support.
...
- **Testing & Performance:** automated / unit testing, BenchmarkDotNet, performance tuning
