# Cover Letter — Misr Technology Services (Senior Software Developer)

**Headline** — _LinkedIn note to the hiring team / email opener:_

> Alexandria-based .NET engineer who has built the secure distributed backend you're describing — an OpenID Connect identity server, a Consul + API-gateway service mesh, RabbitMQ and Temporal Saga messaging, and gRPC APIs — with data-protection and PII-masking work on top.
...
I'm applying for the Senior Software Developer role, and I'm based in Alexandria. At Andalusia Health Business Solution I architect and build scalable, secure microservices and APIs on .NET Core and ASP.NET Core Web API — the core of what this role asks for.

Mapping to your requirements:

- C# / .NET Core / ASP.NET Core Web API following SOLID, DRY, and Clean Architecture, with Repository, Dependency Injection, and CQRS patterns.
- RESTful and gRPC API design across distributed modules; Entity Framework Core and LINQ over SQL Server and PostgreSQL.
