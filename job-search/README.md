...
| `build-cvs.mjs` | Converts each `job-application/*/Moamen_Basyoni_*.md` **and** `Cover_Letter.md` draft to `.docx` + `.pdf` (strips the "NOT PART OF …" notes section first) |
...
- `<Role>.md` — the job description
- `Moamen_Basyoni_<Role>.md` — tailored CV (+ a "gaps to close" section)
- `Cover_Letter.md` — headline (for the LinkedIn note / email opener) + full cover letter
