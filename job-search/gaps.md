...
| Gap | Appears in | Note |
|---|---|---|
| **Years of experience (~3 vs 4–8 asked)** | Areeb (5+, "expert-level"), Significa (5+), Sana Commerce (4+), MTS (5+), Misbar Alkawn (5+), Raya Holding (4+) | Not fixable except by time. Every cover letter counters with scope/depth evidence instead of claiming years. Worth watching — if this keeps costing screens, the fix is skewing the search toward lower experience floors, which Batches 5–6 already started doing (Edenred 3–7, Jaheziya 3–8, Clover Infotech 3–6, Hire Feed 3+). |
